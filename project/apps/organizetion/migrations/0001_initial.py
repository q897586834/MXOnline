# Generated by Django 2.1.1 on 2018-11-15 16:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizetion.CityDict', verbose_name='所在城市')),
            ],
            options={
                'verbose_name': '课程机构',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizetion.CourseOrg', verbose_name='所属机构')),
            ],
            options={
                'verbose_name': '教师',
